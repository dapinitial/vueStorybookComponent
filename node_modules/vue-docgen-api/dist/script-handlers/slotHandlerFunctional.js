...
function slotHandler(documentation, path) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var functionalPath, renderPath, renderValuePath, contextVariable, contextVariableName_1, childrenVarValueName_1;
        return __generator(this, function (_b) {
            if (bt.isObjectExpression(path.node)) {
                ...
                renderValuePath = bt.isObjectProperty(renderPath[0].node)
                    ...
                    : renderPath[0];
                contextVariable = renderValuePath.get('params', 1);
                if (contextVariable.value) {
                    if (bt.isIdentifier(contextVariable.value)) {
                        contextVariableName_1 = contextVariable.value.name;
                        ...
                        childrenVarValueName_1 = (_a = contextVariable
                            .get('properties')

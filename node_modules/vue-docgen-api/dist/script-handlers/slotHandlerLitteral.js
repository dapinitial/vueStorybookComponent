...
function slotHandler(documentation, path) {
    return __awaiter(this, void 0, void 0, function () {
        var renderPath, i, docBlock, jsDoc, slotTag, name_1, slotDescriptor, bindingsTag;
        return __generator(this, function (_a) {
            if (bt.isObjectExpression(path.node)) {
                renderPath = getProperties_1.default(path, 'render');
                ...
                while (docBlock) {
                    ...
                    if (jsDoc.tags) {
                        slotTag = jsDoc.tags.find(function (a) { return a.title === 'slot'; });
                        if (slotTag) {
                            name_1 = typeof slotTag.content === 'string' ? slotTag.content : 'default';
                            slotDescriptor = documentation.getSlotDescriptor(name_1);
                            slotDescriptor.description = jsDoc.description;
                            bindingsTag = jsDoc.tags.filter(function (t) { return t.title === 'binding'; });
                            if (bindingsTag) {
